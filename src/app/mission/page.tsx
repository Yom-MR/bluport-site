  ...
  return (
    <>
      <PageHero
        ...
        image={siteImages.digitalOperations}
        imageAlt="Bluport dispatch operations center with live route maps and fleet tracking dashboards coordinating equipment moves"

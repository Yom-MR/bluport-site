...
const fieldClass =
  "w-full rounded-xl border border-[rgba(148,163,184,0.4)] bg-white px-3.5 py-2.5 text-sm text-slate-900 outline-none transition-colors placeholder:text-slate-400 focus:border-[rgba(14,165,233,0.7)] focus:ring-2 focus:ring-[rgba(14,165,233,0.15)]";
...
export default function ContactMessageBox() {
  ...
  if (isSubmitted) {
    return (
      <div
        className="flex flex-col items-start rounded-[1.5rem] border border-slate-200 bg-white p-8 shadow-[0_1px_3px_rgba(15,23,42,0.06)] md:p-10"
        role="status"
        aria-live="polite"
      >
        ...
        <p className="technical-label mt-5 text-sky-700">MESSAGE SENT</p>
        ...
        <button
          ...
          className="mt-6 inline-flex rounded-xl border border-slate-300 bg-white px-5 py-2.5 text-xs font-semibold uppercase tracking-[0.12em] text-slate-900 transition-colors hover:border-sky-400"
        >
  ...
  return (
    <form
      ...
      noValidate
      className="rounded-[1.5rem] border border-slate-200 bg-white p-6 shadow-[0_1px_3px_rgba(15,23,42,0.06)] md:p-8"
    >
      <div className="grid gap-5">
        <div>
          ...
          <p className="mt-2 flex items-center gap-1.5 text-xs text-slate-500">
            <Mail size={13} aria-hidden className="text-sky-600" />

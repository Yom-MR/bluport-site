    ...
    <section id="request-capacity" className="section-shell section-light">
      <Container className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
        <div className="space-y-5 lg:sticky lg:top-24">
          ...
          <div className="space-y-2 border-t border-[rgba(148,163,184,0.28)] pt-4">
            <p className="technical-label">What happens next</p>
            <ol className="space-y-2 text-sm leading-relaxed text-[var(--muted)] md:text-base">
        ...
        <div className="rounded-3xl border border-[rgba(148,163,184,0.32)] bg-white p-2 shadow-[0_24px_52px_rgba(15,23,42,0.08)] md:p-3">
          <RequestCapacityForm />
        </div>
      </Container>
    </section>
